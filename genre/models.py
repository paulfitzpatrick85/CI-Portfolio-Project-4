...
class Genre(models.Model):
    genre_name = models.CharField(max_length=200, unique=True, default='DEFAULT VALUE')
    slug = models.SlugField(max_length=200, unique=True)
    author = models.ForeignKey(User, on_delete=models.CASCADE, related_name='genre')  # if user is deleted, their posts are too
